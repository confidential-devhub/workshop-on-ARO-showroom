...
If you are using the RHDP demo workshop, then all the instructions should work if run in the provided interface.

If you are running a normal deployed ARO instance, remember:
...
If you are running an Azure self managed cluster, remember:
