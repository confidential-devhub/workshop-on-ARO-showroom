...
Choose which platform you are using:
...
* Navigate to your OpenShift Console URL
* Login as administrator with your credentials
...
If you are running this workshop from an Azure self managed OCP cluster, note that there are very small tweaks to follow, but they are also documented in this guide.
