...
Note that the podspec below deploys a bigger `Standard_DC8es_v5` CVM. If `Standard_DC8es_v5` is not supported in the cluster region, try with `Standard_DC8as_v5`.
