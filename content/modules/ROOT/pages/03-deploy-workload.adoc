...
In this section, we will show you two simple examples of how to respectively enable CoCo in a traditional pod and how to perform attestation. Please refer to the xref:conclusion.adoc[conclusion] to learn about more complex examples with AI, gpus, and so on.
...
...
[INFO  api_server::http::resource] Get resource from kbs:///default/hellosecret/key1
[INFO  api_server::http::resource] Resource access request passes policy check.
[INFO  actix_web::middleware::logger] 10.131.0.9 "GET /kbs/v0/resource/default/hellosecret/key1 HTTP/1.1" 200 514 "-" "attestation-agent-kbs-client/0.1.0" 0.001004
----
+
