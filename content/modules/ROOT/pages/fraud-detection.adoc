...
[IMPORTANT]
====
The script also modifies the signature image verification policy. The OAI workbench is running other signed images from registry.redhat.io, therefore we can extend the policy to also allow them.
====
