...
In case you didn't do it xref:curl_pod.adoc#load-key-trustee[before], download the decryption key and upload it into the Trustee. Remember that `FD_SECRET_NAME=fraud-dataset`.
...
Switch to the default ns again.
