...
This is a simplified, pre-built and containerized version of the https://docs.redhat.com/en/documentation/red_hat_openshift_ai_self-managed/3.4/html/openshift_ai_tutorial_-_fraud_detection_example/index[Openshift AI fraud detection tutorial, window=blank].
