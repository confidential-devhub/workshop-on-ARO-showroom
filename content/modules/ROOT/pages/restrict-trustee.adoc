...
[source,sh,role=execute]
----
oc exec -it pods/pod1 -- curl -s http://127.0.0.1:8006/cdh/resource/default/p1-secret/secret && echo ""
----
+
[source,texinfo,subs="attributes"]
----
[azure@bastion ~]# oc exec -it pods/pod1 -- curl -s http://127.0.0.1:8006/cdh/resource/default/p1-secret/secret && echo ""
Pod 1 secret!
----
...
[source,sh,role=execute]
----
oc exec -it pods/pod1 -- curl -s http://127.0.0.1:8006/cdh/resource/default/p2-secret/secret && echo ""
----
+
[source,texinfo,subs="attributes"]
----
[azure@bastion ~]# oc exec -it pods/pod1 -- curl -s http://127.0.0.1:8006/cdh/resource/default/p2-secret/secret && echo ""
...
[source,sh,role=execute]
----
oc exec -it pods/pod1 -- curl -s http://127.0.0.1:8006/cdh/resource/default/kbsres1/key1 && echo ""
----
+
[source,texinfo,subs="attributes"]
----
[azure@bastion ~]# oc exec -it pods/pod1 -- curl -s http://127.0.0.1:8006/cdh/resource/default/kbsres1/key1 && echo ""
resval1
----
...
[source,sh,role=execute]
----
oc exec -it pods/pod2 -- curl -s http://127.0.0.1:8006/cdh/resource/default/p2-secret/secret && echo ""
----
+
[source,texinfo,subs="attributes"]
----
[azure@bastion ~]# oc exec -it pods/pod2 -- curl -s http://127.0.0.1:8006/cdh/resource/default/p2-secret/secret && echo ""
Pod 2 secret!
----
...
[source,sh,role=execute]
----
oc exec -it pods/pod2 -- curl -s http://127.0.0.1:8006/cdh/resource/default/p1-secret/secret && echo ""
----
+
[source,texinfo,subs="attributes"]
----
[azure@bastion ~]# oc exec -it pods/pod2 -- curl -s http://127.0.0.1:8006/cdh/resource/default/p1-secret/secret && echo ""
rpc status: Status { code: INTERNAL, message: "[CDH] [ERROR]: Get Resource failed", details: [], special_fields: SpecialFields { unknown_fields: UnknownFields { fields: None }, cached_size: CachedSize { size: 0 } } }
----
...
[source,sh,role=execute]
----
oc exec -it pods/pod2 -- curl -s http://127.0.0.1:8006/cdh/resource/default/kbsres1/key1 && echo ""
----
+
[source,texinfo,subs="attributes"]
----
[azure@bastion ~]# oc exec -it pods/pod2 -- curl -s http://127.0.0.1:8006/cdh/resource/default/kbsres1/key1 && echo ""
resval1
----
...
[source,sh,role=execute]
----
oc exec -it pods/pod3 -- curl -s http://127.0.0.1:8006/cdh/resource/default/p1-secret/secret && echo ""
----
+
[source,texinfo,subs="attributes"]
----
[azure@bastion ~]# oc exec -it pods/pod3 -- curl -s http://127.0.0.1:8006/cdh/resource/default/p1-secret/secret && echo ""
rpc status: Status { code: INTERNAL, message: "[CDH] [ERROR]: Get Resource failed", details: [], special_fields: SpecialFields { unknown_fields: UnknownFields { fields: None }, cached_size: CachedSize { size: 0 } } }
----
...
[source,sh,role=execute]
----
oc exec -it pods/pod3 -- curl -s http://127.0.0.1:8006/cdh/resource/default/p2-secret/secret && echo ""
----
+
[source,texinfo,subs="attributes"]
----
[azure@bastion ~]# oc exec -it pods/pod3 -- curl -s http://127.0.0.1:8006/cdh/resource/default/p2-secret/secret && echo ""
rpc status: Status { code: INTERNAL, message: "[CDH] [ERROR]: Get Resource failed", details: [], special_fields: SpecialFields { unknown_fields: UnknownFields { fields: None }, cached_size: CachedSize { size: 0 } } }
----
...
[source,sh,role=execute]
----
oc exec -it pods/pod3 -- curl -s http://127.0.0.1:8006/cdh/resource/default/kbsres1/key1 && echo ""
----
+
[source,texinfo,subs="attributes"]
----
[azure@bastion ~]# oc exec -it pods/pod3 -- curl -s http://127.0.0.1:8006/cdh/resource/default/kbsres1/key1 && echo ""
resval1
----
